...
func NewBlockhain(blockhainAddress string) *BlockChain {
	b := &Block{}
	bc := new(BlockChain)
...
func (bc *BlockChain) Mining() bool {
	bc.AddTransaction(MINING_SENDER, bc.blockhainAddress, MINING_REWARD)
...
func main(){
	...
	blockchain := NewBlockhain(myBlockchainAddress)
	blockchain.Print()
